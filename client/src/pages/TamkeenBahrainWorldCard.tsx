...
const breadcrumbs = [
	{ label: 'Home', href: '/tamkeenbahrain' },
	{ label: 'Cards', href: '/tamkeenbahrain/cards/imtiaz' },
	{ label: 'IMTIAZ World', href: '/tamkeenbahrain/cards/world' },
									...
									<a
										...
										onClick={(e) => {
											...
											if (button.label === 'Apply for IMTIAZ') {
												navigate('/tamkeenbahrain/cards/apply?card=world')
											}
										}}
