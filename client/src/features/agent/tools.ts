...
export async function executeAgentTool(tool: string, args: any): Promise<any> {
	...
	switch (tool) {
		...
		case 'openBaptismFourDayJordanItinerary':
			...
			return { success: true, navigatedTo: '/baptism/guided-tours/4', itineraryId: 4, itineraryName: 'Biblical Jordan' }
		...
		case 'openBaptismFourDayTourRequest':
			...
			return { success: true, navigatedTo: '/baptism/guided-tours/4/request', itineraryId: 4, itineraryName: 'Biblical Jordan' }
