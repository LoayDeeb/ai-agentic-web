  ...
  return <div className="flex justify-between items-center gap-6 flex-nowrap px-0 py-6 w-full">
      ...
      <div className="flex-grow-[4] flex-shrink flex-basis-0">
        <div className="cursor-pointer relative">
						<a className="text-[rgb(22,22,22)] flex items-center text-left h-10 transition-all duration-300 ease-out whitespace-nowrap min-h-10 gap-1 pr-10 text-base font-normal leading-6 border border-[rgb(157,164,174)] rounded pl-4 m-0" href="#" onClick={(e) => { e.preventDefault(); setSortOpen(!sortOpen); }}>
          ...
          {sortOpen && <ul className="absolute z-[9999] min-w-full text-base text-[rgb(31,42,55)] list-none bg-white border border-[rgb(210,214,219)] rounded p-2 mt-2 shadow-[0_2px_4px_0_rgba(16,24,40,0.06),0_4px_8px_0_rgba(16,24,40,0.1)]">
              <li>
							<a className="text-[rgb(22,22,22)] flex items-center text-sm font-normal leading-5 mb-3 pr-6 block w-full clear-both text-left whitespace-nowrap rounded py-2 pl-2 hover:bg-gray-100 transition-colors" href="#" onClick={(e) => { e.preventDefault(); handleSortSelect('asc', 'A to Z'); }}>
                  A to Z
                </a>
              </li>
              <li>
							<a className="text-[rgb(22,22,22)] flex items-center text-sm font-normal leading-5 m-0 pr-6 block w-full clear-both text-left whitespace-nowrap rounded py-2 pl-2 hover:bg-gray-100 transition-colors" href="#" onClick={(e) => { e.preventDefault(); handleSortSelect('desc', 'Z to A'); }}>
                  Z to A
                </a>
              </li>
            </ul>}
